...
class QuotationComparisonController extends Controller
{
    ...
    public function comparison($id)
    {
        ...
        return view('admin.quotationcomparison.comparison', $data);
    }
    ...
    public function compare(Request $request,$id)
    {
        ...
        return redirect(
            route('comparison.comparison.admin')
        )->with('success', 'Quotation was added successfully!');
    }
    ...
    public function generateQuotation($inquiry_id)
    {
        ...
        return view('admin.quotationcomparison.generatefrominquiry', $data);
    }
    ...
    public function pdfinquiry($id)
    {
        ...
        $pdf = PDF::loadView('admin.quotationcomparison.pdf-invoice', $data);
