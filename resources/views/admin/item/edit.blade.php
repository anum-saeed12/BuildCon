            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <form class="form-horizontal" action="{{ route('item.update.admin',$data->item_id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="col-md-3">
                                        <div class="row mb-2">
                                            <div class="col">
                                                ...
                                                <img src="{{ asset('storage/images/'.$data->picture) }}" onerror="this.src='{{ asset('assets/img/not-found.png') }}'" style="display:block;position:relative;border:1px solid #ccc;max-width:100%;" alt="{{ $data->item_name }}">
                                                <div class="input-group mt-3">
                                                    <span>Choose a different picture</span>
                                                    <input name="picture" type="file" class="form-control-file" accept=".jpg,.jpeg,.png,.svg">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
