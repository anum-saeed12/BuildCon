                                ...
                                @forelse($inquires as $inquiry)
                                    <tr style="cursor:pointer" class="no-select" data-toggle="modal"
                                        ...
                                        <td class="text-right p-0">
                                            ...
                                            @if($inquiry->inquiry_status=='open')<a class="bg-success list-btn" data-toggle="tooltip" data-placement="bottom" href="{{ route('quotation.generate.team',$inquiry->id) }}" title="Generate Quotation"><i class="fas fa-file" aria-hidden="false"></i></a>@endif
                                            <a class="bg-primary list-btn" data-toggle="tooltip" data-placement="bottom" href="{{ route('inquiry.edit.team',$inquiry->id) }}" title="Edit"><i class="fas fa-tools" aria-hidden="false"></i></a>
                                            <a class="bg-danger list-btn" data-toggle="tooltip" data-placement="bottom" href="{{ route('inquiry.delete.team',$inquiry->id) }}"  title="Delete"><i class="fas fa-trash-alt" aria-hidden="false"></i></a>
                                        </td>
                                    </tr>
                                    @empty
                                        <tr>
