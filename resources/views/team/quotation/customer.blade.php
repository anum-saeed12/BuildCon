                            ...
                            <table class="table table-hover text-nowrap table-compact">
                                ...
                                @forelse($quotations as $quotation)
                                    <tr style="cursor:pointer" class="no-select" data-toggle="modal"
                                        ...
                                        <td><a href="{{ route('quotation.view.team',$quotation->quotation_id) }}">{{ ucwords($quotation->customer_name) }}</td>
                                        <td><a href="{{ route('quotation.view.team',$quotation->quotation_id) }}">{{ ucwords($quotation->project_name) }}</td>
                                        <td><a href="{{ route('quotation.view.team',$quotation->quotation_id) }}">{{ \Carbon\Carbon::parse($quotation->date)->format('d-M-Y')}}</td>
                                        <td><a href="{{ route('quotation.view.team',$quotation->quotation_id) }}">{{ $quotation->total }}</td>
                                        <td><a href="{{ route('quotation.view.team',$quotation->quotation_id) }}">{{ ucfirst($quotation->username) }}</td>
