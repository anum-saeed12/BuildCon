                                ...
                                @forelse($vendor_quotation as $quotation)
                                    <tr style="cursor:pointer" class="no-select" data-toggle="modal"
                                        ...
                                        <td class="text-right p-0">
                                            ...
                                            <a class="bg-danger list-btn" data-toggle="tooltip" data-placement="bottom" href="{{ route('vendorquotation.delete.team',$quotation->id) }}" title="Delete"><i class="fas fa-trash-alt" aria-hidden="false"></i></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
