                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 item-container">
                                    ...
                                    <select name="item_id[]" class="form-control form-control-sm" id="item_id"  data-target="#brand_id" data-href="{{ route('item.fetch.ajax.sale') }}" data-spinner="#item_spinner" onchange="itemSelect($(this))">
