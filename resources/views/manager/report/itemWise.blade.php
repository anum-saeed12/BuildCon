...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3">
                    <form class="form-horizontal" action="{{ route('report.itemwise.manager') }}" method="GET" id="categorySelect">
                    ...
                    <div class="card">
                        <div class="row mb-3 mt-3 ml-3">
                            ...
                            @if(request('category_id'))
                                <a href="{{ route('itemwise.reportPDF.manager',request('category_id')) }}" class="btn btn-success"><i class="fa fa-plus-circle mr-1"></i>Download PDf</a>
                            @endif
                        </div>
                        </div>
