...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3">
                    <form class="form-horizontal" action="{{ route('vendorQuotes.report.manager') }}" method="GET" id="itemSelect">
                    ...
                    <div class="card">
                        <div class="row mb-3 mt-3 ml-3">
                            ...
                            <div class="col-md-6 text-right pr-md-4">
                                ...
                                @if(request('item_id'))
                                <a href="{{ route('vendorQuotes.reportPDF.manager',request('item_id')) }}" class="btn btn-success"><i class="fa fa-plus-circle mr-1"></i>Download PDf</a>
                                @endif
                            </div>
                        </div>
