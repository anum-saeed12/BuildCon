                                ...
                                @forelse($items as $item)
                                    <tr style="cursor:pointer" class="no-select" data-toggle="modal"
                                        ...
                                        <td class="text-right p-0">
                                            <a class="bg-primary list-btn"  href="{{ route('item.edit.manager',$item->item_id) }}" title="Edit"><i class="fas fa-tools" aria-hidden="false"></i></a>
                                            <a class="bg-danger list-btn"  href="{{ route('item.delete.manager',$item->item_id) }}"  title="Delete"><i class="fas fa-trash-alt" aria-hidden="false"></i></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
